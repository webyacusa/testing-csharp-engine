namespace RetroBlitDemoReel
{
    ...
    public class SceneDemo
    {
        ...
        /// Formatting string
        /// </summary>
        protected FastString mFormatStr = new FastString(8192);

        /// <summary>
        /// Final string to print to screen
        /// </summary>
        protected FastString mFinalStr = new FastString(8192);
        ...
        public virtual void Update()
        {
            ...
            if ((Input.mousePresent && RB.ButtonPressed(RB.BTN_POINTER_B)) || RB.ButtonPressed(RB.BTN_X))
            {
                demo.PreviousScene();
            }
